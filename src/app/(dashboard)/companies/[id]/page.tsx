    ...
    <div>
      <div className="md:flex md:items-center md:justify-between mb-8">
        ...
        <div className="mt-4 flex md:mt-0 md:ml-4 space-x-3">
          {company.email && (
            <button
              onClick={() => (document.getElementById("company-email-modal") as HTMLElement).style.display = "block"}
      ...
      {company.email && (
        <div id="company-email-modal" style={{ display: "none" }}>
          <EmailCompose
            to={company.email}
            onClose={() => (document.getElementById("company-email-modal") as HTMLElement).style.display = "none"}
          />
        </div>
      )}
    </div>
